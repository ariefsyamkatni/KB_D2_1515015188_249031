...
% Pada Section GOAL ini digunakan untuk memenggil  data atau fakta dari mahasiswa yang mengikuti matakuliah Intelegensi Buatan, dimana sudah diseklarasikan dengan perintah diatas.
% Goal ini untunk menampilkan domain tersebut dari perintah ' "CLAUSES mahasiswa_yang_mengikuti_matakuliah_intelegensi_buatan:- .......write("Nim\t\t Nama Mahasiswa\t\t Nama Dosen\t Ruang\t\t Alamat\n"),
