...
% Pada Section GOAL ini digunakan untuk memanggil  data atau fakta matakuliah yang diajarkan pada semester ini.
% ¢	Yang ditampilkan pada output ini adalah nama mahasiswa, diikut sertakan nama matakuliahnya, ruang yang digunakan, dan nama dosen yang mengajar. Semua data itu didapatkan dari pendeklarasian section CLAUSE  